    ...
    for table in tables:
        ...
        for attribut in attributs:
            ...
            if '_ID' not in attribut:
                ...
                #get the foreign table where to store the vale for case 2 and 3
        ...
        for table2 in tables:
            ...
            if table + '_ID' == attributs2[0]:
                #get the table of the other attribut by removing _id to the name
    ...
    for field , descr in fields.items():
        ...
        if not form_info[field] == '':
            ...
            if descr['case'] == 1:
                ...
                #case 3
                if descr['case'] == 3:
                    result = insert_case_2_3(con,descr,form_info[field],inserted_elem['ID'])
                    if not result:
                        return
...
def insert_case_2_3(con,field_descr,value,table_ID = None ):
    ...
    if table_ID and new_tuple:
        ...
        query = 'INSERT INTO {} VALUES (:table_ID,:foreign_id)'.format(relation)
...
def insert_query(insert_values,table):
    ...
    query = 'INSERT INTO {} ({}) VALUES ({})'.format(table,field_names,key_names)
    return query
